...
namespace Kursivoy_Konkin.Manager
{
    ...
    public partial class FormHeadDetailsClients : Form
    {
        private int _clientId;
        public FormHeadDetailsClients(int clientId)
        {
            _clientId = clientId;
            InitializeComponent();
            LoadClientData();
        ...
        private void FormHeadDetailsClients_FormClosing_1(object sender, FormClosingEventArgs e)
        {
